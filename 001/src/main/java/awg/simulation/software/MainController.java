...
public class MainController {
    @FXML private ComboBox<String> waveformType, resolutionCombo, channelSelect, modulationType;
    ...
    @FXML private CheckBox syncChannels, iqSignal;
    @FXML private Canvas waveformCanvas;
    @FXML private Button importCsvButton, generateButton, clearCanvasButton;
    ...
    private void toggleDrawMode() {
        if (drawToggle.isSelected()) {
            ...
            drawGrid(); /// Redraw grid when exiting draw mode
        }
    }
